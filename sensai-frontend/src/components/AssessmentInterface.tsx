          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="flex items-center gap-2">
                ...
                {currentQuestion.type === "case-study" && <Lightbulb className="w-5 h-5 text-yellow-500" />}
              ...
              <>
                ...
                >
                  {currentQuestion.options?.map((option, index) => (
                    <div key={index} className="flex items-center space-x-3 bg-muted p-4 rounded-lg hover:bg-muted/80 transition-colors">
